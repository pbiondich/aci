...
|---|---|---|
| Doctor-patient interaction time (min) | Direct timing of clinician-patient face time | Observation / direct timing |
| Survey items on attention / engagement | Clinician-reported engagement with patient during visit | Survey |
| Consultation duration | Total encounter length | Direct timing |
| Time searching for information | Time clinician spends on EHR vs. patient | Observation |
| Patients seen per hour | Visit throughput as proxy for efficiency | Operational |

## Aliases Used in Literature
- Doctor-Patient Interaction Time ([[Shuaib 2021 - Scribe Program Patient Throughput Physician Productivity|Shuaib 2021]]: doubled)
- Undivided Attention to Patients ([[Duggan 2025 - Clinician Experiences Ambient Scribe Documentation Burden|Duggan 2025]], [[Stults 2025 - Evaluation Ambient AI Documentation Platform Clinicians|Stults 2025]])
- Focus on Patients During Visit ([[Prasad 2025 - Clinician Perceptions Virtual Scribe Use Survey|Prasad 2025]])
- Documentation Needs Impact My Ability to Talk Face-to-Face ([[Duggan 2025 - Clinician Experiences Ambient Scribe Documentation Burden|Duggan 2025]])
- I Feel Distracted by Documentation While Talking ([[Duggan 2025 - Clinician Experiences Ambient Scribe Documentation Burden|Duggan 2025]])
...
- Patients Seen per Hour ([[Shuaib 2021 - Scribe Program Patient Throughput Physician Productivity|Shuaib 2021]]: +39%)
- Time Searching for Information ([[Karavassilis 2025 - Ambient Voice Technology Same Day Emergency Care SDEC|Karavassilis 2025]])
- I Feel Able to See More Patients ([[Duggan 2025 - Clinician Experiences Ambient Scribe Documentation Burden|Duggan 2025]])
