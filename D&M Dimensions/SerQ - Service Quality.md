...
## Definition
Service Quality assesses the **vendor, implementation, and support experience** — the organizational and operational wrapper around the ambient AI tool. It asks: was the deployment and ongoing support effective?

## What Belongs Here
- Implementation barriers and workflow fit
- Onboarding and training quality
- EHR integration experience (FHIR, APIs, technical support)
- Learning curve and workflow adaptation
- Specialty fit and template compatibility
- Governance model and patient consent compliance
- Adoption barriers related to structural/support factors

## What Does NOT Belong Here
- Provider satisfaction with the product itself (→ [[US - User Satisfaction]])
- Adoption rates and utilization (→ [[U - Use]])

## Canonical Measures in this Dimension (1)
- [[CM-23 Implementation Barriers and Workflow Fit]] (8 papers)
