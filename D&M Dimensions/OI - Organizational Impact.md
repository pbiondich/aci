...
> This dimension restores the original DeLone & McLean (1992) Organizational Impact construct. It was collapsed into [[NB - Net Benefits]] in the 2003 update but is reinstated here because organizational- and patient-level outcomes are meaningfully distinct from clinician-level outcomes in healthcare AI evaluation.

## Definition
Organizational Impact captures the effect of the ACI system on the health system and its patients. It asks: what concrete value did this produce for the organization and the patients it serves?

## What Belongs Here
- Patient experience and relationship quality
- Physician-patient interaction quality (face time, attention, therapeutic alliance)
...
- ED flow metrics (door-to-room, length of stay)
- System-level billing and compliance metrics

## What Does NOT Belong Here
- Clinician time savings (→ [[II - Individual Impact]])
- Provider feelings about workflow (→ [[US - User Satisfaction]])
- Note quality (→ [[IQ - Information Quality]])

## Canonical Measures in this Dimension (6)
...
**Physician-Patient Interaction (CM-18):** Measured primarily through clinician self-report; direct patient-side measurement is rare. Shuaib 2021 is the only time-motion study showing direct face time nearly doubling.
...
---
*D&M Dimensions | ACI Evidence Review Vault | Created 2026-05-05*
*Restores DeLone & McLean (1992) Organizational Impact; previously collapsed into NB per 2003 update*
