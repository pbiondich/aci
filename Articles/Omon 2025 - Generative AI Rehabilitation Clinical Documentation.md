...
|---|---|---|
| Documentation Time (seconds) | Third-party-measured time from sitting at EMR to completed registration. Phase A: 305 ± 53.9 s; Phase B: 336 ± 78.0 s. **No significant difference** (p=ns). Editing burden from incomplete voice input offset any AI efficiency gain. | [[II - Individual Impact]] |
| NASA-TLX Temporal Demand (Time Pressure) | NASA-TLX subscale on perceived time urgency during documentation (0–100 VAS). Significantly lower with medimo (AVE Phase A: 58.0, Phase B: 49.8; p=0.037). Only subscale showing significant improvement. | [[US - User Satisfaction]], [[II - Individual Impact]] |
...
| Voice Memo Frequency | Count of non-conversational voice memos recorded per participant during Phase B. Strong positive correlation with documentation time reduction (r=0.71, p=0.006). Behavioral proxy for tool engagement and utilization intensity. | [[U - Use]], [[II - Individual Impact]] |
