...
| Average Documentation Time per Patient (min) | Primary efficiency metric — how long including proofing time. Included in ACDQI (scored: 10 × minutes, max 400 if ≤10 min; score = 0 if >10 min). Used in 2/11 studies. | [[II - Individual Impact]] |
| Out-of-Hours EHR Documentation Time | Time spent documenting outside working hours. Used in 2/11 studies as a WOW/after-hours burden metric. | [[II - Individual Impact]], [[US - User Satisfaction]] |
| Words per Minute (documentation speed) | Speed of clinical note production. One study found ACD 2.7× faster than typing and dictation for history; 2.2× faster for physical exam vs. typing; 3.1× faster vs. dictation. | [[II - Individual Impact]] |
| Work Relative Value Units (WRVU) | Monthly/yearly productivity measure (US Medicare reimbursement framework). Used in 1/11 study (Haberle 2024) as a proxy for clinical value productivity. | [[OI - Organizational Impact]] |
...
| PROMIS Sleep Disturbance (Short Form 4a) | Patient Reported Outcomes Measurement Information System sleep measure. Used in 1/11 study to assess wellbeing impact of documentation burden relief. Unusual/novel outcome for ACD literature. | [[US - User Satisfaction]], [[II - Individual Impact]] |
| Patient Likelihood to Recommend | Single-item patient satisfaction proxy. Used in 1/11 study (Haberle 2024). Broad measure, highly susceptible to confounders per authors. | [[OI - Organizational Impact]] |
| Patient Opt-Out Rate | Number of patients declining ACD use in their consultation. Acceptability/consent proxy. Used in 1/11 study (Haberle 2024). | [[U - Use]], [[OI - Organizational Impact]] |
| Patient Safety Events | Occurrence of safety events attributable to ACD use. Used in 1/11 study (Haberle 2024). No safety events reported in that study. | [[IQ - Information Quality]], [[OI - Organizational Impact]] |
