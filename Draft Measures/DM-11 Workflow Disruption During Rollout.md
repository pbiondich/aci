...
|---|---|---|
| Weekly productivity tracking during rollout | Patient volume, documentation time, and note completion rates tracked weekly for the first 90 days | EHR telemetry + scheduling data |
| Disruption depth and duration | Maximum productivity loss and time to return to baseline or improvement | EHR telemetry |
| Clinician sentiment during transition | Weekly pulse surveys during the first 60 days of rollout | Survey |
| Operational cost of transition | Extra support staffing, reduced schedules, and coverage costs during rollout | Financial records |

## Key Questions for Validation
- Did you experience a productivity dip during ACI rollout, and how long did it last?
- How did you plan for and manage the transition period operationally?
- Would data on expected disruption depth and duration influence your rollout strategy?
- Did the transition experience differ across sites, specialties, or clinician types?
