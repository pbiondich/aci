# DM-10 Onboarding and Training Burden
...
|---|---|---|
| Time to proficiency | Days or encounters from first use to independent use without support | Training records + clinician self-report |
| Training hours required | Formal and informal training hours per clinician during onboarding | Training records |
| Support ticket volume during ramp-up | IT and super-user support requests during the first 30/60/90 days | IT help desk data |
| Productivity dip measurement | Temporary reduction in clinical productivity during the learning curve | EHR telemetry + scheduling data |

## Key Questions for Validation
- How long does it take a new clinician to become comfortable with your ACI tool?
- What does your training program look like, and what resources does it require?
- Is training burden a factor when comparing ACI products?
- Does onboarding difficulty vary by clinician age, specialty, or technical comfort?
