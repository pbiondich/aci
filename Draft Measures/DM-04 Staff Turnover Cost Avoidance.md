# DM-04 Staff Turnover Cost Avoidance
...
|---|---|---|
| Clinician turnover rate comparison | Pre/post or ACI-user vs. non-user voluntary departure rates | HR records |
| Intent-to-leave survey | Validated measure of intention to leave current position, tracked over time | Survey |
| Replacement cost modeling | Estimated cost avoided per retained clinician, using institutional recruitment data | Financial modeling |
| Time-to-retention outcome | Longitudinal tracking (12-24 months) of retention for ACI-adopting vs. non-adopting clinicians | HR records |

## Key Questions for Validation
- Do you currently track clinician turnover rates in relation to technology interventions?
- Would demonstrating a link between ACI and retention change how you prioritize the investment?
- What evidence would your board require to accept a "retention ROI" argument?
- Is there a difference in how you'd value retention of physicians vs. APPs vs. other staff?
