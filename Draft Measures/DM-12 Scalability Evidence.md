# DM-12 Scalability Evidence

**Status:** Draft — pending key informant validation
**D&M Dimension:** [[SQ - System Quality]]

## Definition
Evidence that ACI tool performance, reliability, and outcomes hold at enterprise scale — across hundreds of providers, multiple specialties, and multiple sites — rather than degrading as deployment expands beyond a pilot cohort. Distinct from system reliability (DM-11), which measures uptime; scalability measures whether outcomes observed in a small pilot generalize to full organizational deployment.
